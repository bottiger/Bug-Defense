...
public class TowerDefense extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case MENU_RESUME:
                ...
                return true;
            case MENU_EASY:
                mTowerDefenseThread.setDifficulty(TowerDefenseThread.DIFFICULTY_EASY);
                return true;
            case MENU_MEDIUM:
                mTowerDefenseThread.setDifficulty(TowerDefenseThread.DIFFICULTY_MEDIUM);
                return true;
            case MENU_HARD:
                mTowerDefenseThread.setDifficulty(TowerDefenseThread.DIFFICULTY_HARD);
                return true;
        }
    ...
    protected void onPause() {
        super.onPause();
        mTowerDefenseView.getThread().pause(); // pause game when Activity pauses
    }
